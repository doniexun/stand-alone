 ...
 * @Time : 16:40
 */
package cn.savor.standalone.log.command.local.file.copy;
 ...
 */
@NoArgsConstructor
public class CommandCopy extends LocalFileOperation implements ICommand {
...
//            };
    ...
    public String getInformation() {
        ...
        information.append("Command copy argument:").append("\n");
