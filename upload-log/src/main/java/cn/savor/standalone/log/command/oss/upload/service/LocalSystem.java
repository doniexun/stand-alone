 ...
 * @Time : 16:16
 */
package cn.savor.standalone.log.command.oss.upload.service;
...
public class LocalSystem {
    ...
    public static LocalFile loopDirectory(File directory) {
        if (directory == null) {
        ...
        for (File file : files) {
            if (file.isDirectory()) {
                LocalFile localFileTemp = loopDirectory(file);
    ...
    public static LocalFile loopDirectory(String directory) {
